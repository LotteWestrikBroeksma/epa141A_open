...
if _name_ == "_main_":
    ...
    results.to_pickle('../data/opt_pf2_100k_e001_step1.pkl')

    # Save the convergence object using pickle
    with open('../data/convergence__pf2_100k_e001_step1.pkl', 'wb') as f:
        pickle.dump(convergence, f)


    #Save Results
    results.to_csv('../data/optimization__pf2_100k_e001_step1.csv'.format(problem_formulation,nfe))
